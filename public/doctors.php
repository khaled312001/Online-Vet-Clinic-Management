...
<body>
    <header>
        <h1>Meet Our Expert Veterinarians</h1>
<?php
session_start();
?>
...
<a href="tel:+1234567890" class="floating-call">📞 Emergency Call</a>
    ...
    <section id="doctors">
        <h2>Our Team of Skilled Veterinarians</h2>
        <p>Our highly experienced veterinarians are dedicated to providing the best care for your pets.</p>
        <div class="doctor-list">
            <div class="doctor-item">
                <img src="images/doctor1.jpg" alt="Dr. Sarah Johnson">
                <h3>Dr. Sarah Johnson</h3>
                <p>Specialist in small animal care with over 10 years of experience.</p>
            </div>
            <div class="doctor-item">
                <img src="images/doctor2.jpg" alt="Dr. Michael Brown">
                <h3>Dr. Michael Brown</h3>
                <p>Expert in surgical procedures and emergency veterinary care.</p>
            </div>
            <div class="doctor-item">
                <img src="images/doctor3.jpg" alt="Dr. Emily Clarke">
                <h3>Dr. Emily Clarke</h3>
                <p>Specialized in exotic pets and advanced diagnostic techniques.</p>
            </div>
            <div class="doctor-item">
                <img src="images/doctor4.jpg" alt="Dr. John Doe">
                <h3>Dr. John Doe</h3>
                <p>Renowned in pet nutrition and wellness management.</p>
            </div>
        </div>
    </section>
